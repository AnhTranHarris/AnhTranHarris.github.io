...
(() => {
  ...
  edgeStyle.textContent=`
    ...
    @media(min-width:901px){
      ...
      .desktop-edge-fallback .page::before{border:10px solid rgba(255,220,112,.96);background:none;box-shadow:none}
