...
(()=>{
  ...
  style.textContent=`
    ...
    .carousel-edge-corner-flare::before{content:"";position:absolute;left:4px;right:4px;top:50%;height:1px;transform:translateY(-50%);background:linear-gradient(90deg,transparent,rgba(255,231,145,.30) 24%,rgba(255,255,246,1) 49%,rgba(255,255,246,1) 51%,rgba(255,231,145,.30) 76%,transparent);box-shadow:0 0 4px rgba(255,244,190,.48)}
    .carousel-edge-corner-flare::after{content:"";position:absolute;left:9px;right:9px;top:7px;bottom:7px;border-radius:50%;border:1px solid rgba(255,232,150,.15);transform:rotate(-28deg)}
  `;
